...
export const EmojiCard = ({verdict, emoji, expression, id}) => {
  ...
  const handleMouseIn = () => setStyles({backgroundColor: 'transparent', color: 'black', border: '2px solid yellow'})

  const handleMouseOut = () => setStyles({backgroundColor: 'black', color: 'white', border: '2px solid black'})
